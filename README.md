...
- [Метрические классификаторы](#Метрические-классификаторы)
  ...
  { 
   ...
   Чтобы найти оптимальные значение ширины окна h для Парзеновского окна воспользуемся критерием скользящего контроля LOO (Leave One Out).
    ...
    :---:|:----------:|:--------------------:
    Треугольное|![](pwlootrian.png)|![](pwmaptrian.png)
    Прямоугольное|![](loopwrect.png)|![](pwmaprect.png)
    Квартическое|![](loopwkvar.png)|![](pwmapkvar.png)
    Епанечниково|![](loopwep.png)|![](pwmapep.png)
    Гауссовское|![](loopwgauss.png)|![](pwmapgauss.png)
  ...
  findPotentials <- function(data, core, h, maxErr = 5) {
   ...
   :---:|:----------:|:--------------------:
   Гауссовское|![](demopoten.png)|![](gausspotenmap.png)
   Треугольное|![](demopotentrian.png)|![](trianpotenmap.png)
